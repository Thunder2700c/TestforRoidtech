...
function renderVideos() {
  document.getElementById('video-container').innerHTML = featuredVideos.map(v => `
    <div class="video-item glass-effect anim-card">
      <div class="video-embed"><iframe src="https://www.youtube.com/embed/${v.embedId}?rel=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
